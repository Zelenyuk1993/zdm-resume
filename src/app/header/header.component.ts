  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Web Resume - Dmytro Zeleniuk",
        text: "Hello, I'm a Web Developer with 8+ years of experience designing web and mobile projects. Find out more in my web-resume!",
        url: "https://zdm-official.com"
      });
    } catch(error) {
